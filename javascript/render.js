...
<a class="item-tabs" href='anime-1-nft.html'>
    ...
    <div class="info">
        <div class='sub-info'>
            ...
            <button class='js-add-cart' id='cart-icon' data-image-id=${item.image}><i class="fa-solid fa-bag-shopping fa-xl"></i></button>
            <button class='js-add-fav' id='fav-icon' data-image-id=${item.image}><i class="fa-regular fa-heart fa-xl"></i></button>
        </div>
